...
export const STAGE_META: Record<string, { label: string; cls: string; step: number }> = {
  ...
  NOMINATED: { label: "Nominated", cls: "bg-navy-50 text-navy-700 border-navy-200", step: 2 },
  COMPANY_REVIEWING: { label: "Company Reviewing", cls: "bg-indigo-50 text-indigo-700 border-indigo-200", step: 3 },
  SHORTLISTED: { label: "Shortlisted", cls: "bg-violet-50 text-violet-700 border-violet-200", step: 4 },
  INTERVIEW: { label: "Interview", cls: "bg-sky-50 text-sky-700 border-sky-200", step: 5 },
  SELECTED: { label: "Selected", cls: "bg-amber-50 text-amber-700 border-amber-200", step: 6 },
  PLACED: { label: "Placement Confirmed", cls: "bg-teal-50 text-teal-700 border-teal-200", step: 7 },
...
export const JOURNEY_STEPS = [
  "INTERESTED", "NOMINATED", "SHORTLISTED", "INTERVIEW", "SELECTED", "PLACED",
];
